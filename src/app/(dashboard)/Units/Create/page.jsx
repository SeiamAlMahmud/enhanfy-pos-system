...
export default function AddUnits() {
  ...
  const initialUnits = [
    ...
    },
    {
      ...
      relatedSign: '*',
      relatedBy: '1',
      result: 'Shoes_pair_2 = 1 Dozen * 1',
    },
    {
      id: 12,
      name: 'Shoes_pair_3',
      relatedTo: 'Shoes_pair_2',
      relatedSign: '*',
      relatedBy: '12',
      result: 'Shoes_pair_3 = 1 Shoes_pair_2 * 12',
    },
    {
      id: 13,
      name: 'Pcs',
    ...
    },
    {
      ...
      relatedSign: '*',
      relatedBy: '100',
      result: 'Square Meter = 1 Meter * 100',
    },
    {
      id: 25,
      name: 'Tonne_2',
  ...
  const handleAddUnit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/units/post-units`,
        {
          method: 'POST',
