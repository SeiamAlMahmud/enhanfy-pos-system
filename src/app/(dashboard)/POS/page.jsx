        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="p-2 bg-white dark:bg-[#202047]  shadow-sm w-full">
            <div className="flex flex-col gap-4 dark:text-black items-center w-full">
              ...
              <div className="flex w-full gap-5">
                ...
                {/* Add Button */}
                <button
                  className="bg-emerald-500 text-white w-[50%] px-4 py-2 rounded-md hover:bg-teal-600 focus:outline-none"
                  onClick={() =>
            ...
            <dialog id="my_modal_3" className="modal">
              <div className="modal-box max-w-2xl">
                <form method="dialog">
                  ...
                  <button className="btn btn-sm btn-circle btn-ghost absolute right-3 top-3 dark:text-black">
                    ✕
                  </button>
                </form>
                <div className=" bg-opacity-50 w-full dark:text-black">
                  <div className=" p-6">
                    ...
                    {/* Form */}
                    <form
                      className="bg-white shadow-sm rounded px-8 pt-6 pb-8 mb-4 text-sm dark:bg-[#181838] "
                      onSubmit={handleSubmit}
                    >
                      <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full  px-3 mb-6 md:mb-0">
                          <label
                            className="block  tracking-wide text-gray-700 dark:text-white text-xs  mb-2"
          ...
          <div className="bg-white dark:bg-[#202047] p-2  shadow-sm">
              ...
              {filteredProducts?.slice(0, 10)?.map((product) => (
                ...
                >
                  ...
                  <p className=" dark:text-white mt-2 ">
                    {product.product_name} - 0000{product.id}
                  </p>
            ...
            <div className="flex justify-center mt-4">
              <button className="px-4 py-2 mx-2 bg-gray-200 rounded-md hover:bg-gray-300">
                1
              </button>
              <button className="px-4 py-2 mx-2 bg-gray-200 rounded-md hover:bg-gray-300">
                2
