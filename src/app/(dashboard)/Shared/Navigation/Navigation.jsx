    ...
    <div className="w-[100%] lg:w-[86%] fixed top-0 z-50 font-nunito text-sm">
      <div className="navbar bg-white dark:bg-[#141432] backdrop-blur-sm items-start  flex justify-between py-6">
        <div className="navbar-start flex items-center">
          ...
          <a className=" text-gray-500 dark:text-white  md:text-md ml-5">
            Repwoop POS Software
          </a>
        </div>
        {/* nav center */}
          ...
          <div className="dropdown dropdown-end">
            <div>
              {isLoggedIn ? (
                <Link href="/">
                  <button
                    className="bg-rose-500 p-1 px-5 rounded-full text-white flex items-center gap-1 cursor-pointer"
                    onClick={logout}
                  >
                    Logout <ArrowRightFromLine size={16} />
                  </button>
                </Link>
              ) : (
                <Link href="/Login">
                  {' '}
                  <button className="bg-cyan-500 p-1 px-5 rounded-full text-white flex items-center gap-1 ">
                    {' '}
