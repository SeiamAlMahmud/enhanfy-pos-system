...
export default function ProductData() {
  ...
  const exportPDF = () => {
    ...
    products.forEach((product, index) => {
      doc.text(
        `${index + 1}. ${product?.product}, SKU: ${product?.sku}, Price: $${product?.price}`,
        20,
        20 + index * 10
      );
    });
  ...
  const submitProducts = async () => {
    ...
    try {
      ...
      if (response?.ok) {
        toast.success(
          data.message || 'File uploaded and data inserted successfully'
        );
        setShowModal(false);
      } else {
    ...
    <div className="font-nunito text-sm">
      <div className="container mx-auto px-4  md:mt-[7%] mt-[20%] font-nunito text-sm">
        ...
        <div className="md:flex mflex-col md:flex-row justify-between items-center mb-4">
          <h2 className=" dark:text-white text-lg  mb-2 md:mb-0">
            Product List
          </h2>
        ...
        <div className="overflow-x-auto">
          <table
            id="table-to-print"
            className="min-w-full table-auto  bg-white dark:bg-[#1c1c3c] dark:text-white shadow-sm  overflow-hidden"
          >
            <thead>
                  ...
                  <tr key={product?.id} className="border-t border-gray-200 ">
                    ...
                    <td className="px-4 py-2 flex space-x-2">
                      <button
                        ...
                        className="border  p-2 transform hover:scale-110 hover:bg-[#092C4C] hover:text-white"
                      >
                      ...
                      <button
                        ...
                        className="p-2  transform text-red-500 hover:bg-red-500 hover:text-white hover:scale-110 border"
                      >
                      ...
                      {/* Modal */}
                      {modalVisible && (
                        <div className="fixed inset-0 flex items-center justify-center bg-opacity-50 transition-all duration-300 ease-in-out">
                            ...
                            {modalAction === 'edit' && (
                              <div>
                                <form
                                  ...
                                  className="p-4 bg-white shadow-lg dark:bg-[#202047]"
                                >
