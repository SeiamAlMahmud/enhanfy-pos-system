              ...
              {accounts?.map((account, index) => (
                ...
                >
                  ...
                  <td className="py-2 px-2 md:px-4 border">
                    Tk.{parseFloat(account.opening_balance).toFixed(2)}
                  </td>
                  <td className="py-2 px-2 md:px-4 border">
                    Tk.{parseFloat(account.current_balance).toFixed(2)}
                  </td>
                  <td className="py-2 px-2 md:px-4 border grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <Link
                      href={`/Bank_Accounts/${account.account_id}/history`}
          ...
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-4 md:p-8 shadow-sm w-full max-w-xs md:max-w-md lg:max-w-lg mx-2">
              <div className="flex justify-between items-center mb-4">
                <h2 className=" dark:text-white text-md md:text-lg">
                  Add Balance to {selectedAccount?.name}
                </h2>
                <button
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setBalanceForm({ ...balanceForm, owner: e.target.value })
                  }
                >
        ...
        {showTransferModal && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-4 md:p-8 shadow-sm w-full max-w-xs md:max-w-md lg:max-w-lg mx-2">
              <div className="flex justify-between items-center mb-4">
                <h2 className=" dark:text-white text-md md:text-lg">
                  Transfer Balance From {selectedAccount?.name}
                </h2>
                <button
                  className="text-gray-500 text-lg"
